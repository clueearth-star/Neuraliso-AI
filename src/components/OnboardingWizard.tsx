            ...
            >
              ...
              >
                <div className="relative">
                  ...
                  {/* Tiny satellite floating particle */}
                  <div 
                    className="absolute -top-1 -right-1 w-5 h-5 rounded-full bg-indigo-100 flex items-center justify-center shadow-lg border border-white text-[10px] animate-bounce"
              ...
              >
                ...
                <p className="text-xs font-sans text-muted-text font-semibold tracking-tight uppercase">
                  Biomedical CBT Space & Sound Lab
                </p>
              </div>
              ...
              >
                Cross into immediate stress first-aid, tactile biometric stabilizers, generative sound wave structures, and clinical cognitive adaptation matrices.
              </p>
              ...
              >
                <button
                  ...
                  className="w-full bg-gradient-to-r from-deep-sage to-primary-sage hover:from-primary-sage hover:to-deep-sage text-white py-4 rounded-full font-bold text-xs uppercase tracking-wider transition-all duration-300 active:scale-95 shadow-lg shadow-deep-sage/20 border border-white/20 cursor-pointer flex items-center justify-center gap-2"
                >
                  <Sparkles className="w-4 h-4 animate-spin-slow" />
                  <span>Get Started & Run Diagnostics</span>
                </button>
                ...
                >
                  ...
                  <span>{authLoading ? "Connecting..." : "Enter Free Onboard Sandbox"}</span>
                </button>
                ...
                <div className="grid grid-cols-2 gap-3.5">
                  ...
                  >
                    📖 {showLearnMore ? "Close Scope" : "System Scope"}
                  </button>
                  <button
              ...
              <AnimatePresence>
                {showLearnMore && (
                  ...
                  >
                    <span className="text-[9px] font-bold text-slate-700 block uppercase tracking-amber">🌿 BIOMECHANICAL CLINICAL SCOPE</span>
                    <ul className="space-y-2 text-slate-500 font-sans list-disc pl-4 leading-normal">
                      <li><strong>Cognitive Restructuring</strong>: Multi-stage CBT journaling prompts targeting unhelpful core schemas.</li>
                      <li><strong>Acoustic Tuning Station</strong>: Custom wave frequency overlay matrices integrating pure Solfeggio sound.</li>
                      <li><strong>Active Vagal Vane SOS</strong>: Interactive eye-lateralization widgets and tactical deep-breath monitors.</li>
                    </ul>
                  </motion.div>
                )}
              </AnimatePresence>

              <div className="pt-2 border-t border-slate-100 flex justify-between text-[8px] font-mono text-muted-text font-bold">
                <span className="flex items-center gap-1"><ShieldCheck className="w-2.5 h-2.5 text-emerald-500" /> HIPAA CLINICAL SYNC</span>
                <span>SECURE CRYPTO VAULT</span>
              </div>
            </div>
          </motion.div>
        )}
